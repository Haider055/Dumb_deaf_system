package com.dumb.dumb_deaf_system.favorites;
...
import com.dumb.dumb_deaf_system.fragments.no_favorites;
...
public class myfavourites extends AppCompatActivity implements adapter_myfav.del{
    ...
    if (list.isEmpty()){
        no_favorites no_favorites = new no_favorites();
        FragmentManager fragmentManagerpro = getSupportFragmentManager();
        FragmentTransaction fragmentTransactionpro = fragmentManagerpro.beginTransaction();
        fragmentTransactionpro.replace(R.id.linear,no_favorites);
